$(document).ready(function () {
  ...
  if ($(".dribbble-feed").length) {
    jribbble.shots(
      {
        token:
          "473dd3d76e3133f33d86079f9c1dbee3c0a8bf8daadafc8e25c6684937f040fd",
        per_page: 6,
      },
      function (shots) {
        document.querySelector(".dribbble-feed").innerHTML = shots.reduce(
          function (html, shot) {
            return (
              html +
              '<div class="item col-xs-6 col-sm-4 col-md-2"><figure class="overlay overlay1"><a href="' +
              shot.html_url +
              '" target="_blank"></a><img src="' +
              shot.images.normal +
  ...
  $.scrollUp({
    ...
    scrollText:
      '<span class="btn btn-square btn-rounded btn-icon"><i class="et-chevron-small-up"></i></span>',
  ...
  /*	STYLE TOGGLE
    /*-----------------------------------------------------------------------------------*/
  $("body.show-switcher").append(
    '<div class="style-toggle-wrapper"><input class="dn" type="checkbox" id="dn"/><label class="style-toggle" for="dn"><span class="style-toggle-handler"></span></label></div>'
  );
