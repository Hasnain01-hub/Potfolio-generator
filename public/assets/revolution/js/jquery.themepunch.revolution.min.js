      ...
      return (
        ...
        this.each(function () {
          ...
          (a.minHeight =
            ...
            (a.jsFileLocation =
              a.jsFileLocation ||
              getScriptLocation("themepunch.revolution.min.html")),
    ...
    compare_version: function (a) {
      ...
      return (
        ...
        b.Core === undefined &&
          ...
          (b.Core.name = "jquery.themepunch.revolution.min.html"),
  ...
  var _ISM = _R.is_mobile(),
    ...
    getScriptLocation = function (a) {
      ...
      return (
        ...
        (c = c.replace("jquery.themepunch.revolution.min.html", "")),
        (c = c.replace("jquery.themepunch.revolution.html", "")),
        (c = c.split("?")[0])
      );
    },
    ...
    abstorel = function (a, b) {
      var c = a.split("https://demos.elemisthemes.com/"),
        d = b.split("https://demos.elemisthemes.com/");
      c.pop();
      for (var e = 0; e < d.length; e++)
        "." != d[e] && (".." == d[e] ? c.pop() : c.push(d[e]));
      return c.join("https://demos.elemisthemes.com/");
    },
          ...
          if ((c.attr("src", f.src), "img" == f.type))
            if (c.hasClass("defaultimg"))
              _R.isIE(8)
                ...
                : (-1 == f.src.indexOf("images/transparent.html") &&
                    -1 == f.src.indexOf("assets/transparent.html")) ||
